...
import { LogOut, Settings, Package, Home, Menu, X, Users, MapPin, Bike, Truck, Wallet, BarChart3, MessageCircle, FileText, Award, Star, ShoppingCart, Calculator } from "lucide-react"
...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const menuItems = [
    ...
    { href: "/admin/pdv", icon: Calculator, label: "PDV" },
